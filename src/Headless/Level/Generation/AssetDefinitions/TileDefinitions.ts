...
import LaserGun, {
  LaserColor
} from 'Headless/Level/GameObjects/PrePlaced/LaserGun';
import DirtWall from 'Headless/Level/GameObjects/PrePlaced/DirtWall';
...
import Tile from 'Headless/Level/Generation/AssetLoading/Tile';
